...
<html lang="en">
    <head>
        ...
        for ($k = 0; $k < sizeof($statdate); $k++) {
            array_push($staterror, array($statdate[$k][Date], $statdate[$k][Error]));
            array_push($statwarn, array($statdate[$k][Date], $statdate[$k][Warning]));
            array_push($stattotal, array($statdate[$k][Date], $statdate[$k][Total]));
            array_push($statsuccess, array($statdate[$k][Date], $statdate[$k][Success]));
        }
        ?>
    </head>
    <body>
                ...
                <section class="bm-wrapper">
                    <div class="row mt">
                        <div class="col-md-12 space">
                            <div class="splinetime-content-panel">
                                <!--<div class="col-sm-10">-->
                                <!--<form>-->
                                <div>
                                ...
                                <div id="splinetime" style="width: 100%; height: 740px; margin: 0 auto"></div>
                            </div><!-- /content-panel -->
                        </div><!-- /col-md-12 -->
                    </div><!-- /row -->
                </section><! --/wrapper -->
...
//                                                    minorGridLineColor: '#C5EEFA',
                                            ...
                                            options.title.text = <?php echo json_encode($_GET['BS'] . " - " . $_GET['BO']); ?>;
